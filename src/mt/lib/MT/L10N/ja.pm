...
## default_templates/comments.mtml
	...
	'# Comments' => 'コメント(#)',
	'No Comments' => 'コメント(0)',
	'The data is modified by the paginate script' => 'ページネーションスクリプトがデータを変更します。',
...
## lib/MT/CMS/Common.pm
	...
	'This action can only be run on a single blog at a time.' => 'この操作は1つのブログに対してのみ行えます。',
	'Invalid blog_id' => '不正なブログID',
	'The Site URL matches the original blog' => '元のブログと同じサイトURLです。',
...
## lib/MT/CMS/Template.pm
	...
	'Copy of [_1]' => '[_1]のコピー',
	'Cannot publish a global template.' => 'グローバルテンプレートを公開できません。',
	'template' => 'テンプレート',
...
## lib/MT/Core.pm
	...
	'Refreshes object summaries.' => 'オブジェクトのサマリーを更新',
	'Adds Summarize workers to queue.' => 'サマリー作成のタスクをキューに追加',
	'zip' => 'zip',
	'tar.gz' => 'tar.gz',
...
## lib/MT/Template/ContextHandlers.pm
	...
	'[_1] is not a hash.' => '[_1]はハッシュではありません。',
	'The \'[_2]\' attribute will only accept an integer: [_1]' => '[_2]属性には数値を設定してください: [_1]',
...
## tmpl/cms/cfg_registration.tmpl
	...
	'One or more Perl modules may be missing to use this authentication method.' => '設定された認証方式を使うのに不足しているPerlモジュールがあります。',
...
## tmpl/cms/cfg_system_general.tmpl
	...
	'Debug Mode' => 'デバッグモード',
	'You can find an explanation of the various debug modes in the <a href="http://www.movabletype.org/documentation/developer/plugins/debug-mode.html">documentation</a>' => 'デバッグモードについて詳しくは<a href="http://www.movabletype.jp/documentation/appendices/config-directives/debugmode.html">ドキュメント</a>を参照してください。',
	'Performance Logging' => 'パフォーマンスログ',
	'Turns on or off performance logging.' => 'パフォーマンスログを記録',
	'Log Paths' => 'ログの保存先',
	'Paths where logs are placed.' => 'ログを保存するパス',
	'Logging Threshold' => 'ログのしきい値',
	'Logging threshold for the App' => 'ログのしきい値',
	'Send Email To' => 'メールの送信先',
	'The email address where you want to send test email to.' => 'テストメールを送信するメールアドレス',
...
## tmpl/cms/dialog/clone_blog.tmpl
	...
	'Exclusions' => '除外',
	'Exclude Entries/Pages' => 'ブログ記事とウェブページを除外',
	...
	'Back' => '戻る',
	'Blog Details' => 'ブログの詳細',
	'Enter the new URL of your public website. Example: http://www.example.com/weblog/' => 'WebサイトのURL(http://www.example.com/weblog/など)を入力してください。',
	'Enter a new path where your main index file will be located. Example: /home/melody/public_html/weblog' => 'メインページのファイルを作成する場所(/home/melody/public_html/weblogなど)を入力してください。',
	'Clone Settings' => '複製の設定',
	'Mark the settings that you want cloning to skip' => '複製しないオブジェクトを指定します。',
...
## tmpl/cms/view_rpt_log.tmpl
	...
	'Showing all Schwartz errors' => 'Schwartz のエラーをすべて表示',
